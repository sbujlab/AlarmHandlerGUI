...
Magnet_readback_tolerances = [0.035,0.025,0.025,0.025,0.025,0.025,0.025,0.1,0.025,0.025]
...
if AllGood is False:
  print("Please check the magnet set points and readbacks. If a Dipole is bad then check detector alignment\n")
else:
  print("OK")
